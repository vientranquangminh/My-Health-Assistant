class ArticleObject {
  ...
  ArticleObject(
      {this.time, this.title, this.category, this.imgUrl, this.content});
}

List<ArticleObject> listArticle = [
  ArticleObject(
      time: 'Dec 22, 2022',
      title:
  ...
  ArticleObject(
      ...
      content: '''
          ...
          The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.
        ''',
      title: 'Colorectal cancer: Why adult in 40s and 50s need to get screened',
      category: 'Medical',
      imgUrl:
          'https://cdn.thuvienphapluat.vn/uploads/tintuc/2022/01/30/cap-nhat-huong-dan-dieu-tri-covid.jpg'),
];
